            ...
            <div className="inline-flex gap-2 md:gap-3 px-4 animate-none">
              {[...categories, ...categories].map((category, index) => (
                <button
                  ...
                  className="inline-flex items-center px-3 md:px-4 py-1.5 md:py-2 rounded-full text-xs md:text-sm font-medium transition-all hover:scale-105 whitespace-nowrap cursor-pointer"
                  style={{
        ...
        <DialogContent className="bg-gradient-to-br from-gray-900 via-black to-gray-900 border-2 border-accent-amber/40 max-w-md mx-auto">
          <DialogHeader>
            <DialogTitle className="text-center text-2xl md:text-3xl font-bold text-white flex items-center justify-center gap-3">
              <Sparkles className="w-6 h-6 md:w-8 md:h-8 text-accent-amber animate-pulse" />
              <span className="text-accent-amber">{selectedCategory}</span>
              <Sparkles className="w-6 h-6 md:w-8 md:h-8 text-accent-amber animate-pulse" />
            </DialogTitle>
          </DialogHeader>
          ...
          <div className="py-6 md:py-8 text-center space-y-6">
            ...
            <p className="text-gray-400 text-sm md:text-base max-w-xs mx-auto leading-relaxed">
              <span className="text-white font-medium">{selectedCategory}</span> etkinlikleri için geri sayım başladı. 
