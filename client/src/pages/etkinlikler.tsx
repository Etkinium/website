          ...
          >
            <div className="p-6 sm:p-8">
              <h3 className="text-lg sm:text-xl font-bold text-white text-center mb-6">
                Neden <span className="text-accent-amber">ETKİNİUM</span>?
              </h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  { icon: "🔒", title: "Güvenli Ödeme", desc: "256-bit SSL şifreleme" },
                  { icon: "⚡", title: "Anında Bilet", desc: "QR kod ile hızlı giriş" },
                  { icon: "🛡️", title: "İptal Güvencesi", desc: "Bilet koruma seçenekleri" },
                  { icon: "🎯", title: "Puan Kazan", desc: "Her alışverişte puan" },
                ].map((feature, i) => (
